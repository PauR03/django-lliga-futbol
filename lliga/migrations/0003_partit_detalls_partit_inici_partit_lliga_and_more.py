# Generated by Django 4.2 on 2024-02-29 18:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('lliga', '0002_partit_resultat_local_partit_resultat_visitant'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='partit',
            name='local',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partits_local', to='lliga.equip'),
        ),
        migrations.AddField(
            model_name='partit',
            name='visitant',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partits_visitant', to='lliga.equip'),
        ),
